  ...
  return (
   ...
   <div className='about'>
      ...
      <div className="card-body">
        ...
        <div className="card mb-5">
          <img src="https://images.pexels.com/photos/4144923/pexels-photo-4144923.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" class="card-img-top" alt="..."/>
      <div className="card-body">
      ...
      <div className="card-body">
          <h5 className="card-title">Nuestra Mision</h5>
          <p className="card-text">Nuestra misión es transformar la educación a través de la tecnología, proporcionando acceso a cursos y recursos educativos de calidad a estudiantes de todas las edades y orígenes. Nos comprometemos a fomentar un entorno de aprendizaje inclusivo, accesible y efectivo que inspire a los estudiantes a alcanzar su máximo potencial.</p>
      </div>
        </div>
        <div className="card mb-5">
      ...
      <div className="card-body">
          <h5 className="card-title">Que Ofrecemos</h5>
